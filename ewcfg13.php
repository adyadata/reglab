...
define("EW_PROJECT_NAME", "reglab", TRUE); // Project name
...
define("EW_RANDOM_KEY", 'u3OpAvnKelhw0ooo', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "admin", "db" => "db_reglab", "qs" => "`", "qe" => "`");
...
@define("EW_USER_LEVEL_TABLE", "`t_user_levels`", TRUE);
...
@define("EW_USER_LEVEL_PRIV_TABLE", "`t_user_level_permissions`", TRUE);
...
define("EW_SENDER_EMAIL", "info@reglab.com", TRUE); // Sender email address
