...
$RootMenu->AddMenuItem(14, "mmci_Input", $Language->MenuPhrase("14", "MenuText"), "", -1, "", TRUE, FALSE, TRUE);
$RootMenu->AddMenuItem(6, "mmi_t_daftarm", $Language->MenuPhrase("6", "MenuText"), "t_daftarmlist.php", 14, "", AllowListMenu('{BDF410E2-F8A1-44BF-83FA-BA321C2274F7}t_daftarm'), FALSE, FALSE);
