...
class ct_audit_trail extends cTable {
	...
	function __construct() {
		...
		// datetime
		$this->datetime = new cField('t_audit_trail', 't_audit_trail', 'x_datetime', 'datetime', '`datetime`', ew_CastDateFieldForLike('`datetime`', 9, "DB"), 135, 9, FALSE, '`datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
