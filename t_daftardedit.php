...
$t_daftard_edit = NULL; // Initialize page object first

class ct_daftard_edit extends ct_daftard {
	...
	// Page object name
	var $PageObjName = 't_daftard_edit';
...
// Create page object
if (!isset($t_daftard_edit)) $t_daftard_edit = new ct_daftard_edit();

// Page init
$t_daftard_edit->Page_Init();

// Page main
$t_daftard_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_daftard_edit->Page_Render();
?>
...
var CurrentForm = ft_daftardedit = new ew_Form("ft_daftardedit", "edit");

// Validate form
ft_daftardedit.Validate = function() {
...
ft_daftardedit.Form_CustomValidate = 
...
ft_daftardedit.ValidateRequired = true;
<?php } else { ?>
ft_daftardedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_daftardedit.Lists["x_PraktikumID"] = {"LinkField":"x_PraktikumID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","x_Biaya","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_praktikum"};
...
<?php } ?>
<?php $t_daftard_edit->ShowPageHeader(); ?>
<?php
$t_daftard_edit->ShowMessage();
?>
<?php if (!$t_daftard_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t_daftard_edit->Pager)) $t_daftard_edit->Pager = new cPrevNextPager($t_daftard_edit->StartRec, $t_daftard_edit->DisplayRecs, $t_daftard_edit->TotalRecs) ?>
<?php if ($t_daftard_edit->Pager->RecordCount > 0 && $t_daftard_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t_daftard_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t_daftard_edit->PageUrl() ?>start=<?php echo $t_daftard_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t_daftard_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t_daftard_edit->PageUrl() ?>start=<?php echo $t_daftard_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t_daftard_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t_daftard_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t_daftard_edit->PageUrl() ?>start=<?php echo $t_daftard_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t_daftard_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t_daftard_edit->PageUrl() ?>start=<?php echo $t_daftard_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t_daftard_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="ft_daftardedit" id="ft_daftardedit" class="<?php echo $t_daftard_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_daftard_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_daftard_edit->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_daftard_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php if (!isset($t_daftard_edit->Pager)) $t_daftard_edit->Pager = new cPrevNextPager($t_daftard_edit->StartRec, $t_daftard_edit->DisplayRecs, $t_daftard_edit->TotalRecs) ?>
<?php if ($t_daftard_edit->Pager->RecordCount > 0 && $t_daftard_edit->Pager->Visible) { ?>
