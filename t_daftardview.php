...
$t_daftard_view = NULL; // Initialize page object first

class ct_daftard_view extends ct_daftard {
	...
	// Page object name
	var $PageObjName = 't_daftard_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["DaftradID"] <> "") {
			$this->RecKey["DaftradID"] = $_GET["DaftradID"];
			$KeyUrl .= "&amp;DaftradID=" . urlencode($this->RecKey["DaftradID"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["DaftradID"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["DaftradID"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["DaftradID"] <> "") {
				...
				$this->RecKey["DaftradID"] = $this->DaftradID->QueryStringValue;
			} elseif (@$_POST["DaftradID"] <> "") {
				$this->DaftradID->setFormValue($_POST["DaftradID"]);
				$this->RecKey["DaftradID"] = $this->DaftradID->FormValue;
			} else {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if ($this->TotalRecs <= 0) { // No record found
						...
						$this->Page_Terminate("t_daftardlist.php"); // Return to list page
						...
						while (!$this->Recordset->EOF) {
							if (strval($this->DaftradID->CurrentValue) == strval($this->Recordset->fields('DaftradID'))) {
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "t_daftardlist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "t_daftardlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t_daftard_view)) $t_daftard_view = new ct_daftard_view();

// Page init
$t_daftard_view->Page_Init();

// Page main
$t_daftard_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_daftard_view->Page_Render();
?>
...
var CurrentForm = ft_daftardview = new ew_Form("ft_daftardview", "view");

// Form_CustomValidate event
ft_daftardview.Form_CustomValidate = 
...
ft_daftardview.ValidateRequired = true;
<?php } else { ?>
ft_daftardview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_daftardview.Lists["x_PraktikumID"] = {"LinkField":"x_PraktikumID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","x_Biaya","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_praktikum"};
...
<?php if ($t_daftard->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$t_daftard_view->IsModal) { ?>
<?php if ($t_daftard->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $t_daftard_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t_daftard_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t_daftard_view->IsModal) { ?>
<?php if ($t_daftard->Export == "") { ?>
...
<?php } ?>
<?php $t_daftard_view->ShowPageHeader(); ?>
<?php
$t_daftard_view->ShowMessage();
?>
<?php if (!$t_daftard_view->IsModal) { ?>
<?php if ($t_daftard->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t_daftard_view->Pager)) $t_daftard_view->Pager = new cPrevNextPager($t_daftard_view->StartRec, $t_daftard_view->DisplayRecs, $t_daftard_view->TotalRecs) ?>
<?php if ($t_daftard_view->Pager->RecordCount > 0 && $t_daftard_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t_daftard_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t_daftard_view->PageUrl() ?>start=<?php echo $t_daftard_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t_daftard_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t_daftard_view->PageUrl() ?>start=<?php echo $t_daftard_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t_daftard_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t_daftard_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t_daftard_view->PageUrl() ?>start=<?php echo $t_daftard_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t_daftard_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t_daftard_view->PageUrl() ?>start=<?php echo $t_daftard_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t_daftard_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="ft_daftardview" id="ft_daftardview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_daftard_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_daftard_view->Token ?>">
<?php } ?>
...
<?php echo $t_daftard->PraktikumID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
