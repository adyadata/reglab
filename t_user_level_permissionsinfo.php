...
$t_user_level_permissions = NULL;

//
// Table class for t_user_level_permissions
//
class ct_user_level_permissions extends cTable {
	var $userlevelid;
	var $_tablename;
	var $permission;
	...
	function __construct() {
		...
		$this->TableVar = 't_user_level_permissions';
		$this->TableName = 't_user_level_permissions';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t_user_level_permissions`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// userlevelid
		$this->userlevelid = new cField('t_user_level_permissions', 't_user_level_permissions', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, -1, FALSE, '`userlevelid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tablename
		$this->_tablename = new cField('t_user_level_permissions', 't_user_level_permissions', 'x__tablename', 'tablename', '`tablename`', '`tablename`', 200, -1, FALSE, '`tablename`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_tablename->Sortable = TRUE; // Allow sort
		$this->fields['tablename'] = &$this->_tablename;

		// permission
		$this->permission = new cField('t_user_level_permissions', 't_user_level_permissions', 'x_permission', 'permission', '`permission`', '`permission`', 3, -1, FALSE, '`permission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t_user_level_permissions`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t_user_level_permissionslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t_user_level_permissionsview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t_user_level_permissionsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t_user_level_permissionsadd.php?" . $this->UrlParm($parm);
		else
			$url = "t_user_level_permissionsadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t_user_level_permissionsedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t_user_level_permissionsadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t_user_level_permissionsdelete.php", $this->UrlParm());
	}
