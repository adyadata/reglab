...
//
// Table class for t_user_levels
//
class ct_user_levels extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't_user_levels';
		$this->TableName = 't_user_levels';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t_user_levels`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// userlevelid
		$this->userlevelid = new cField('t_user_levels', 't_user_levels', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, -1, FALSE, '`userlevelid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// userlevelname
		$this->userlevelname = new cField('t_user_levels', 't_user_levels', 'x_userlevelname', 'userlevelname', '`userlevelname`', '`userlevelname`', 200, -1, FALSE, '`userlevelname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t_user_levels`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t_user_levelsview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t_user_levelsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t_user_levelsadd.php?" . $this->UrlParm($parm);
		else
			$url = "t_user_levelsadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t_user_levelsedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t_user_levelsadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t_user_levelsdelete.php", $this->UrlParm());
	}
