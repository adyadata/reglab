...
class ct_user_edit extends ct_user {
	...
	function RenderRow() {
		...
		$this->NIM->ViewCustomAttributes = "";
			...
			$sSqlWrk = "SELECT `userlevelid`, `userlevelname` AS `DispFld`, '' AS `Disp2Fld`, '' AS `Disp3Fld`, '' AS `Disp4Fld`, '' AS `SelectFilterFld`, '' AS `SelectFilterFld2`, '' AS `SelectFilterFld3`, '' AS `SelectFilterFld4` FROM `t_user_levels`";
			$sWhereWrk = "";
			$this->UserLevel->LookupFilters = array();
			ew_AddFilter($sWhereWrk, $sFilterWrk);
			$this->Lookup_Selecting($this->UserLevel, $sWhereWrk); // Call Lookup selecting
	...
	function SetupLookupFilters($fld, $pageId = null) {
		...
		case "x_UserLevel":
			$sSqlWrk = "";
			$sSqlWrk = "SELECT `userlevelid` AS `LinkFld`, `userlevelname` AS `DispFld`, '' AS `Disp2Fld`, '' AS `Disp3Fld`, '' AS `Disp4Fld` FROM `t_user_levels`";
			$sWhereWrk = "";
			$this->UserLevel->LookupFilters = array();
...
ft_useredit.Lists["x_UserLevel"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_user_levels"};
...
<?php if ($t_user->_UserID->Visible) { // UserID ?>
	<div id="r__UserID" class="form-group">
		<label id="elh_t_user__UserID" class="col-sm-2 control-label ewLabel"><?php echo $t_user->_UserID->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t_user->_UserID->CellAttributes() ?>>
<span id="el_t_user__UserID">
<span<?php echo $t_user->_UserID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $t_user->_UserID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="t_user" data-field="x__UserID" name="x__UserID" id="x__UserID" value="<?php echo ew_HtmlEncode($t_user->_UserID->CurrentValue) ?>">
<?php echo $t_user->_UserID->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<?php if ($t_user->UserLevel->Visible) { // UserLevel ?>
	<div id="r_UserLevel" class="form-group">
		<label id="elh_t_user_UserLevel" for="x_UserLevel" class="col-sm-2 control-label ewLabel"><?php echo $t_user->UserLevel->FldCaption() ?></label>
...
<input type="hidden" name="s_x_UserLevel" id="s_x_UserLevel" value="<?php echo $t_user->UserLevel->LookupFilterQuery() ?>">
</span>
<?php } ?>
...
<?php echo $t_user->NIM->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div>
<?php if (!$t_user_edit->IsModal) { ?>
