...
class ct_user extends cTable {
	...
	function __construct() {
		...
		// UserID
		$this->_UserID = new cField('t_user', 't_user', 'x__UserID', 'UserID', '`UserID`', '`UserID`', 3, -1, FALSE, '`UserID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->_UserID->Sortable = TRUE; // Allow sort
		$this->_UserID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['UserID'] = &$this->_UserID;

		// Nama
		$this->Nama = new cField('t_user', 't_user', 'x_Nama', 'Nama', '`Nama`', '`Nama`', 200, -1, FALSE, '`Nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Nama->Sortable = TRUE; // Allow sort
		$this->fields['Nama'] = &$this->Nama;

		// NoHandphone
		$this->NoHandphone = new cField('t_user', 't_user', 'x_NoHandphone', 'NoHandphone', '`NoHandphone`', '`NoHandphone`', 200, -1, FALSE, '`NoHandphone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NoHandphone->Sortable = TRUE; // Allow sort
		$this->fields['NoHandphone'] = &$this->NoHandphone;

		// Email
		$this->_Email = new cField('t_user', 't_user', 'x__Email', 'Email', '`Email`', '`Email`', 200, -1, FALSE, '`Email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// NIM
		$this->NIM = new cField('t_user', 't_user', 'x_NIM', 'NIM', '`NIM`', '`NIM`', 200, -1, FALSE, '`NIM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->NoHandphone->Exportable) $Doc->ExportCaption($this->NoHandphone);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->NoHandphone->Exportable) $Doc->ExportField($this->NoHandphone);
