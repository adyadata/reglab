...
class cuserpriv extends ct_user_levels {
	...
	function __construct() {
		...
		if (!isset($GLOBALS["t_user_levels"])) $GLOBALS["t_user_levels"] = &$this;
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 't_user_levels');
	...
	function Page_Main() {
		...
		$Breadcrumb->Add("list", "t_user_levels", "t_user_levelslist.php", "", "t_user_levels");
...
<p><?php echo $Language->Phrase("UserLevel") ?><?php echo $Security->GetUserLevelName($t_user_levels->userlevelid->CurrentValue) ?>(<?php echo $t_user_levels->userlevelid->CurrentValue ?>)</p>
<?php
...
<input type="hidden" name="x_userlevelid" id="x_userlevelid" value="<?php echo $t_user_levels->userlevelid->CurrentValue ?>">
...
for ($i = 0; $i < $userpriv->TableNameCount; $i++) {
	$userpriv->TempPriv = $Security->GetUserLevelPrivEx($userpriv->TableList[$i][4] . $userpriv->TableList[$i][0], $t_user_levels->userlevelid->CurrentValue);
